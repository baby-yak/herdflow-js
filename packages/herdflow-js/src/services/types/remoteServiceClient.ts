...
import type { MARKER_REMOTE_SERVICE_CLIENT } from '../../core/internal/brandSymbols.js';
 ...
 */
export interface RemoteServiceClient<Desc extends ServiceDescriptor = ServiceDescriptor> {
  //instance marker
  readonly [MARKER_REMOTE_SERVICE_CLIENT]: true;
